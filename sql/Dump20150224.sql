...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='This entity will hold the attempts of a given test by the user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test_attempt_answers` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_test_attempt_answers_test_attempt1_idx` (`test_attempt_id`),
  KEY `fk_test_attempt_answers_question1_idx` (`question_id`),
  CONSTRAINT `fk_test_attempt_answers_question1` FOREIGN KEY (`question_id`) REFERENCES `question` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_test_attempt_answers_test_attempt1` FOREIGN KEY (`test_attempt_id`) REFERENCES `test_attempt` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='This entity defines the various users in the systems';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (4,'naik.pranil@gmail.com','pranil','naik',1,'evaluator'),(5,'rixonmathew@gmail.com','rixon','mathew',1,'evaluator');
...
-- Dump completed on 2015-02-24 12:06:54
