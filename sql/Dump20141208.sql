CREATE DATABASE  IF NOT EXISTS `leapfh8k_evaluator` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `leapfh8k_evaluator`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This entity will hold the various attributes associated with question e.g complexity or tags (like comprehension, grammar, tenses etc.). For adaptive tests this attributes will be looked to get a question in random';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This entity will hold the attempts of a given test by the user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-12-08  8:23:25
